...
function verifSuscriptionEns(f) {
    var ensName = isAssoNumber(f.ensName);
    var siret = isAssoNumber(f.assoNumber);
    ...
    if(ensName && siret && contactNameOk && contactFirstNameok && emailOk && phoneOk && loginOk)
        return true;
    else {
