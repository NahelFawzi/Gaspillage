	...
	<section id="buttons" class="col-lg-12">
		<div class="container">
			<div class="box">
				...
				<a href="suscriptionEns.php"><button><strong>INSCRIPTION</strong></button></a>
			</div>
		</div>
	</section>
	<section id="why" class="col-lg-12">
		<div class="container">
			<h2 class="col-lg-5">POURQUOI M'INSCRIRE ?</h2>
			<p>Lorem ipsum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum lorem ispum </p>
		</div>
	</section>
